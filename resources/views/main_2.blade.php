...
<head>
    ...
    <!-- bootstrap css -->
    <link rel="stylesheet" href="{{ asset('assets/ver2/css/bootstrap.min.css')}}">
    <!-- style css -->
    <link rel="stylesheet" href="{{ asset('assets/ver2/css/style.css')}}">
    <!-- Responsive-->
    <link rel="stylesheet" href="{{ asset('assets/ver2/css/responsive.css')}}">
    <!-- fevicon -->
    <link rel="icon" href="{{ asset('assets/ver2/images/fevicon.png')}}" type="image/gif" />
    <!-- Tweaks for older IEs-->
    <link rel="stylesheet" href="{{ asset('assets/ver2/css/owl.carousel.min.css')}}">
    <link rel="stylesheet" href="https://netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css">
    <link rel="stylesheet" href="{{ asset('assets/ver2/css/bootstrap-datepicker.min.css')}}">
    <!--[if lt IE 9]>
...
<!-- loader  -->
<div class="loader_bg">
    <div class="loader"><img src="{{ asset('assets/ver2/images/loading.gif')}}" alt="#"/></div>
</div>
<!-- end loader -->
<div class="full_bg">
    <!-- header -->
                            ...
                            <div class="row d_flex">
                                ...
                                <div class="col-md-7">
                                    <div class="row mar_right">
                                        <div class="col-md-6">
                                            <div class="agency">
                                                <figure><img src="{{ asset('assets/ver2/images/img1.png')}}" alt="#"/></figure>
                                                <div class="play_icon">
                                        ...
                                        <div class="col-md-6">
                                            <div class="agency">
                                                <figure><img src="{{ asset('assets/ver2/images/img2.png')}}" alt="#"/></figure>
                                                <div class="play_icon">
                                                    <a class="play-btn" href="javascript:void(0)"><img src="{{ asset('assets/ver2/images/play_icon.png')}}"></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div id="ho_shad" class="services_box text_align_left">
                    <h3>Luxury Spa</h3>
                    <figure><img src="{{ asset('assets/ver2/images/service3.jpg')}}" alt="#"/></figure>
                    <p>sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip</p>
                    <a class="read_more" href="service.html">Read More</a>
                </div>
            </div>
...
<!-- end footer -->
<!-- Javascript files-->
<script src="{{ asset('assets/ver2/js/jquery.min.js')}}"></script>
<script src="{{ asset('assets/ver2/js/bootstrap.bundle.min.js')}}"></script>
<script src="{{ asset('assets/ver2/js/jquery-3.0.0.min.js')}}"></script>
<script src="{{ asset('assets/ver2/js/owl.carousel.min.js')}}"></script>
<script src="{{ asset('assets/ver2/js/bootstrap-datepicker.min.js')}}"></script>
<script src="{{ asset('assets/ver2/js/custom.js')}}"></script>
</body>
</html>
