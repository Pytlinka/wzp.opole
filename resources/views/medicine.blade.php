...
<div class="container-xxl bg-white p-0" style="background-image: url{{ asset('assets/ver1/img/news_1.jpg')}})">
            ...
            <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-2 p-lg-0" style="background-image: url({{ asset('assets/ver1/img/nav_2c.jpg')}});" title="Obraz autorstwa pikisuperstar na Freepik">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    ...
                    <div class="navbar-nav mr-auto py-1">
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown">Zdrowie pszczół</a>
                            <div class="dropdown-menu rounded-0 m-0">
                                <a href="#" class="dropdown-item">Lista leków</a>
    ...
    <div class="container-fluid page-header mb-5 p-0" style="background-image: url({{ asset('assets/ver1/img/news_1.jpg')}});" title="Obraz autorstwa dgim-studio na Freepik">
        <div class="container-fluid page-header py-5">
            <div class="container text-center pb-5">
                <h1 class="display-3 text-dark mb-3 animated slideInDown" style="margin-top: 30px;" id="linki">Wykaz leków</h1>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="row g-5">
                <div class="col-lg-6">
                    <img src="{{ asset('assets/ver1/img/medicine.png') }}" title="Medicine icons created by Freepik - Flaticon" style="height: 350px; text-align: center;">
                ...
                <div class="col-lg-6">
                    <div class="wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <ul>
                            <li><a href="http://wzp.test/laraview/pdf/Lista-lekow-warroza-01.2023.pdf" style="font-weight: bold; color:black;">Lista leków refundowanych przez ARiMR</a></li>
                            <li><a href="http://wzp.test/laraview/pdf/APIVAR_99_skutecznosci_zwalczania_vd.pdf" style="font-weight: bold; color:black;">APIVAR</a></li>
                            <li><a href="http://wzp.test/laraview/pdf/NOWOSC-Formicprotect-zwalczanie-v.d.-pod-zasklepem.pdf" style="font-weight: bold; color:black;">FORMICPROTECT – NOWOŚĆ!</a></li>
                            <li><a href="http://wzp.test/laraview/pdf/Ulotka-VarroMed.pdf" style="font-weight: bold; color:black;">VARROMED</a></li>
                            <li><a href="https://biowet.pl/produkty/api-bioxal/" style="font-weight: bold; color:black;">API-BIOXAL</a></li>
                            <li><a href="https://www.vet-animal.pl/produkt/oxybee-lek-zwalczania-warrozy/" style="font-weight: bold; color:black;">OXYBEE</a></li>
                            <li><a href="http://wzp.test/laraview/pdf/POLYVARYELLOW_ULOTKA_INF.pdf" style="font-weight: bold; color:black;">POLYVAR YELLOW</a></li>
                            <li><a href="https://www.vet-animal.pl/produkt/apiguard-lek-do-zwalczania-warrozy/" style="font-weight: bold; color:black;">APIGUIARD</a></li>
                            <li><a href="https://biowet.pl/produkty/biowar-500-500mgpasek/" style="font-weight: bold; color:black;">BIOWAR</a></li>
                            <li><a href="https://www.vet-animal.pl/produkt/thymovar-lek-do-zwalczania-warrozy/" style="font-weight: bold; color:black;">THYMOVAR</a></li>
                            <li><a href="https://biowet.pl/produkty/api-life-var/" style="font-weight: bold; color:black;">API LIFE VAR</a></li>
                            <li><a href="https://biowet.pl/produkty/apiwarol-amitraz/" style="font-weight: bold; color:black;">APIWAROL </a></li>
                            <li><a href="http://wzp.test/laraview/pdf/BAYVAROL_ulotka.pdf" style="font-weight: bold; color:black;">BAYVAROL </a></li>
